        ...
        <nav className="h-16 flex items-center justify-between px-6 bg-bg-card border-b border-border-subtle shadow-xl shrink-0">
          ...
          <div className="flex-1 max-w-xl mx-10">
            <div className="relative group">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-text-muted group-focus-within:text-brand-blue transition-colors" size={18} />
              <input 
                type="text" 
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="text-right">
                        <p className="text-lg font-bold text-text-main">${phone.price}</p>
